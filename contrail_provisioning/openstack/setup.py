...
class OpenstackSetup(ContrailSetup):
    ...
    def build_ctrl_details(self):
        ...
        ctrl_infos.append('HEAT_DBPASS=%s' % self._args.heat_dbpass)
        ctrl_infos.append('KEYSTONE_DBPASS=%s' % self._args.keystone_dbpass)
        ctrl_infos.append('NOVA_DBPASS=%s' % self._args.nova_dbpass)
        ctrl_infos.append('GLANCE_DBPASS=%s' % self._args.glance_dbpass)
        ctrl_infos.append('CINDER_DBPASS=%s' % self._args.cinder_dbpass)
