...
class AmqpSetup(ContrailSetup):
    ...
    def parse_args(self, args_str):
        '''
        Eg. setup-vnc-amqp --self_ip 10.1.5.11\
                               --amqp_hosts cfgm1,cfgm2,cfgm3\
                               --amqp_hosts_ip cfgm1_ip,cfgm2_ip,cfgm3_ip\
        ...
        parser.add_argument("--amqp_hosts", nargs='+', type=str,
            help = "List of short hostnames(hostname -s) of amqp nodes")
        parser.add_argument("--amqp_hosts_ip", nargs='+', type=str,
            help = "List of control interface IP address of amqp nodes")
        ...
        parser.add_argument("--verify_all", help = "Force cluster again", action="store_true")
...
def main(args_str = None):
    ...
    # For future AMQP's other than rabbitmq,
