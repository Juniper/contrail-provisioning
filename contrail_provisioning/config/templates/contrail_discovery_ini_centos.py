...
command=/usr/bin/contrail-discovery --conf_file $__contrail_discovery_conf__ --listen_port $__contrail_disc_port_base__%(process_num)01d --worker_id %(process_num)s
