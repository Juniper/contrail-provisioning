...
from contrail_provisioning.commpute.common import ComputeBaseSetup
from contrail_provisioning.commpute.openstack import ComputeOpenstackSetup
...
def main(args_str = None):
    ...
    if compute_args.orch is 'openstack':
        compute = ComputeOpenstackSetup(config_args)
