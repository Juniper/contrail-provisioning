...
class ComputeSetup(ContrailSetup):
    ...
    def parse_args(self, args_str):
        ...
        parser.add_argument("--gateway_server_list", help = "Compute nodes acting as gateway",
                            nargs='+', type=str)
        parser.add_argument("--qos_nic_queue", help = "Logiacl queue for qos")
        parser.add_argument("--qos_queue_scheduling", help = "scheduling algorithm for queue")
        parser.add_argument("--qos_queue_bandwidth", help = "maximum bandwidth for queue")
