...
analytics_configaudit_ttl=$__contrail_configaudit_ttl__
analytics_statsdata_ttl=$__contrail_statsdata_ttl__
analytics_flowdata_ttl=$__contrail_flowdata_ttl__
