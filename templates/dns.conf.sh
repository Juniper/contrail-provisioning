...
CONFIG_FILE="/etc/contrail/contrail-dns.conf"
...
perl -ni -e 's/command=.*/command=\/usr\/bin\/contrail-dns/g; print $_;' /etc/contrail/supervisord_control_files/contrail-dns.ini
